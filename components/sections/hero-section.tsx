...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="w-full overflow-hidden py-20 md:py-32 lg:py-40"
    >
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl text-lg">
              Writing robust software with clean code and agile development
              practices for over 5 years. Passionate about technology since
              forever
            </p>
